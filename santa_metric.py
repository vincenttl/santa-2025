...
def _parse_args():
    parser = argparse.ArgumentParser(description="Compare tree layouts and save results.")
    parser.add_argument("--trees", type=int, default=25, help="Number of trees to place.")
    parser.add_argument("--seed", type=int, default=0, help="Random seed to reproduce runs.")
    parser.add_argument(
        "--output-dir",
        type=Path,
        default=Path("figures"),
        help="Directory to write SVGs and the summary text file.",
    )
